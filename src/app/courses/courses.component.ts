...
export class CoursesComponent {
  ...
  courses = [
    ...
    { id:103, name:'React course for beginners', author: 'Steve Smith', duration: 18.5, type: 'Free', 
    ...
    { id:108, name:'UX Design Course  for beginners', author: 'Steve Smith', duration: 19.0, type: 'Premium', 
  ...
  onSearchTextEntered(searchValue: string){
   return this.searchText = searchValue;
  }
  onFilterRadioButtonChanged(data: string){
   return this.courseCountRadiobutton=data;
  }
}
